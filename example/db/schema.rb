...
ActiveRecord::Schema.define(version: 20150310163512) do
  ...
  add_index "albums", ["band_id", "released_on"], name: "index_albums_on_band_id_and_released_on"
  add_index "albums", ["band_id"], name: "index_albums_on_band_id"
  add_index "albums", ["released_on"], name: "index_albums_on_released_on"
  ...
  add_index "attributions", ["song_id", "writer_id"], name: "index_attributions_on_song_id_and_writer_id", unique: true
  ...
  add_index "membership_roles", ["membership_id", "role_id"], name: "index_membership_roles_on_membership_id_and_role_id", unique: true
  ...
  add_index "memberships", ["band_id", "member_id"], name: "index_memberships_on_band_id_and_member_id", unique: true
